...
public class LoginController {
	...
	public @ResponseBody Object loginCheck(@Valid @ModelAttribute("user1") User user1, BindingResult result, ModelMap model, HttpServletResponse response, HttpServletRequest request) {
